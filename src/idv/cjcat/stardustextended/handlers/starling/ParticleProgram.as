...
public class ParticleProgram
{
    ...
    {
        var painter : starling.rendering.Painter = Starling.current.painter;
        ...
        if (!program) {
            ...
            else // Image shaders
            {
                ...
                fragmentShader = fragmentShader.replace("<???>", RenderUtil.getTextureLookupFlags(texFormat, texMipmap, texRepeat, texSmoothing));
            }

...
public class BitmapFieldRenderer extends FieldRendererBase
{
    ...
    override protected function createContent():void
    {
        ...
        _fileRef.addEventListener(Event.COMPLETE, _onFileComplete);
    ...
    private function _onFileSelect(e:Event):void { _fileRef.load(); }
    ...
    private function _onChange(e:Object):void
    {
        ...
        d.channelX = _xChannelList.selectedItem;
        d.channelY = _yChannelList.selectedItem;

...
public class LineDeflectorRenderer extends DeflectorRendererBase
{
    ...
    {
        _contentRow1.addChild(_lbl("Line   x"));
        _xStepper = _stepper(_contentRow1);
        _contentRow1.addChild(_lbl("y"));
        _yStepper = _stepper(_contentRow1);
        _contentRow1.addChild(_lbl("angle(degrees)"));
        _angleStepper = _stepper(_contentRow1);
    ...
    {
        var d:LineDeflector = LineDeflector(_data);
        _xStepper.value = d.x;
        _yStepper.value = d.y;
        _angleStepper.value = d.normal.angle + 90;
    ...
    private function _onChange(e:Event):void
    {
        ...
        d.x = _xStepper.value;
        d.y = _yStepper.value;
        d.normal.angle = _angleStepper.value - 90;

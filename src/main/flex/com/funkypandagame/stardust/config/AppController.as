...
public class AppController
{
    ...
    public function AppController(starlingRoot:starling.display.Sprite, overlay:Sprite)
    {
        instance = this;
    ...
    private function _onImportSelected(emitters:Vector.<com.funkypandagame.stardust.view.importSim.ImportedEmitter>):void
    {
        for each (var ie:com.funkypandagame.stardust.view.importSim.ImportedEmitter in emitters)
        {
            _projectModel.stadustSim.addEmitter(ie.emitterVo.emitter);
    ...
    {
        _bus.dispatchEvent(new LoadSimEvent(LoadSimEvent.LOAD, bytes, name));
    }
}
}

...
public class AddEmitterCommand
{
    ...
    <StardustParticleSystem version="2.1">
        ...
        <initializers>
            ...
            <Velocity name="Velocity_1" active="true">
                <zones><SinglePoint name="SinglePoint_3"/></zones>
            </Velocity>
        </initializers>
        <emitters>
    ...
    public function AddEmitterCommand(bus:EventDispatcher, model:ProjectModel)
    {
        _bus = bus;
        _projectModel = model;
    }
    ...
    public function execute():void
    {
        ...
        _projectModel.emitterImages[emitterData.id] = new <BitmapData>[bd];
